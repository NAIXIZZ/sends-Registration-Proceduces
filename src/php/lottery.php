...
<head>
    ...
    <script src="../js/jqurry.js"></script>
</head>
...
<body>
    <div class="page">
        ...
        $id = $_SESSION['id'];
        //查询剩余次数
        $sq_query_occasion = "SELECT occasion,gift FROM `lottery` WHERE id = $id;";
        ...
        <div class="turntable" style="position: absolute;left: 50%;transform:translateX(-50%)">
            ...
            <button id="back" class="back" onclick="window.location.href='../html/index.html'">返回首页</button>
            <div class="record">
